...
class OPTClass(BaseLM):
    def __init__(self, args):
        ...
        if "2.7b" in args.model or "6.7b" in args.model:
            ...
            self.model = OPTForCausalLM.from_pretrained(
                self.model_name, cache_dir=args.model_cache_dir, torch_dtype=torch.float16
            )
            self.tokenizer = AutoTokenizer.from_pretrained(
                self.model_name, cache_dir=args.model_cache_dir, use_fast=False
            )
